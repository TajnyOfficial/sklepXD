      ...
      <div className="grid-2" style={{ gap: 24 }}>
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div className="input-group"><label>Telefon</label><input className="input" value={store.phone || ''} onChange={e => setStore({ ...store, phone: e.target.value })} /></div>
            <div className="input-group"><label>E-mail</label><input className="input" value={store.email || ''} onChange={e => setStore({ ...store, email: e.target.value })} /></div>
            <div className="input-group"><label>Nr konta bankowego</label><input className="input font-mono" value={store.bankAccount || ''} onChange={e => setStore({ ...store, bankAccount: e.target.value })} /></div>
